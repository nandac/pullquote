---
title: "Pullquote Test: Invalid pq-font (Fatal Error)"
---
...
This tests the `abort()` trigger for `pq-font`. A CSS-style comma-separated
...
```markdown
::: {.pullquote pq-font="Playfair Display, Georgia"}
