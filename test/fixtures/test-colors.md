...
```markdown
::: {.pullquote pq-color="#827397" pq-bar-color="#E9D8FD" pq-width="70%"}
...
```markdown
::: {.pullquote pq-color="#F00" pq-bar-color="#0F0" pq-width="70%"}
...
```markdown
::: {.pullquote pq-color="Teal!100" pq-bar-color="Teal!30" pq-bar-width="6px"}
